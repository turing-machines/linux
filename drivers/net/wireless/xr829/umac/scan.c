...
static void __ieee80211_scan_completed(struct ieee80211_hw *hw, bool aborted)
{
	...
	if (!hw_scan && (scan_sdata != NULL)) {
		ieee80211_configure_filter(scan_sdata);
...
void ieee80211_run_deferred_scan(struct ieee80211_local *local)
{
	...
	mac80211_queue_delayed_work(&local->hw, &local->scan_work,
				  ...
				  struct cfg80211_scan_request *req)
{
 ...
 again:
	...
	if (hw_scan) {
		...
		ieee80211_configure_filter(local->scan_sdata); /* accept probe-responses */
